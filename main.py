...
modelpath = path + "/" + model_name + "/models/" + "best_model_"+ description + ".h"
...
### model
model = GoogLeNet(aux_logits=True, num_classes=10, init_weights=True).to(device)  ## CAUTION!!! test without auxiliary classifier!
